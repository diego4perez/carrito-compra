...
ALTER TABLE `tbl_detalle_factura`
  ADD PRIMARY KEY (`id_encabezado_factura`,`id_pedido`,`id_carrito`,`id_cliente`,`id_detalle_carrito`,`sku_producto`,`id_proveedor`),
...
ALTER TABLE `tbl_encabezado_factura`
  ADD PRIMARY KEY (`id_factura`,`id_transaccion`,`id_encabezado_factura`,`id_pedido`,`id_carrito`,`id_cliente`,`id_detalle_carrito`,`sku_producto`,`id_proveedor`),
  ADD KEY `tbl_detalle_factura_tbl_encabezado_factura_fk` (`id_encabezado_factura`,`id_pedido`,`id_carrito`,`id_cliente`,`id_detalle_carrito`,`sku_producto`,`id_proveedor`);
...
--
ALTER TABLE `tbl_encabezado_factura`
  ADD CONSTRAINT `tbl_detalle_factura_tbl_encabezado_factura_fk` FOREIGN KEY (`id_encabezado_factura`,`id_pedido`,`id_carrito`,`id_cliente`,`id_detalle_carrito`,`sku_producto`,`id_proveedor`) REFERENCES `tbl_detalle_factura` (`id_encabezado_factura`, `id_pedido`, `id_carrito`, `id_cliente`, `id_detalle_carrito`, `sku_producto`, `id_proveedor`) ON DELETE NO ACTION ON UPDATE NO ACTION;
